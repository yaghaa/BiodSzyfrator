...
namespace BiodSzyfrator
{
    public partial class Form1 : Form
    {
        ...
        {
            return String.Join(((char)13).ToString(), System.IO.File.ReadAllLines(tbSourceFile.Text, Encoding.GetEncoding(1250)));
        }

        private void SaveFile(string text)
        {
            System.IO.File.WriteAllText(tbOutcome.Text, text, Encoding.GetEncoding(1250));
        }
